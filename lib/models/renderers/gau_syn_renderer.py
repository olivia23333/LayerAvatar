...
class GFSRenderer(nn.Module):
    ...
    def render_gaussian_test(self, means3D, colors_precomp, rotations, opacities, scales, cov3D_precomp=None, label=None):
        '''
        mode: normal, phong, texture
        '''
        screenspace_points = (
        ...
        if cov3D_precomp != None:
            ...
            image_, _, _, _ = self.rasterizer(means3D=means3D[opacity_mask], colors_precomp=colors_precomp[opacity_mask], \
