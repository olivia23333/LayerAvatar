...
from ..deformers import SNARFDeformer, SMPLXDeformer, SMPLDeformer
from ..renderers import GRenderer, GFRenderer, GFTRenderer, get_covariance, batch_rodrigues
...
class UVTPDecoder_T(VolumeRenderer):
    ...
    def __init__(self,
        ...
        self.renderer = GFTRenderer(image_size=image_size, bg_color=bg_color, f=2658.661647283995, label=self.pcd_label)
    ...
    # def gaussian_render(self, pcd, sigmas, rgbs, num_scenes, num_imgs, num_points, cameras):
        ...
        # pcd[56282+11056:] = pcd[56282+11056:] + normals[56282+11056:] * 0.01
