...
from lib.apis import evaluate_3d, viz_3d, animate_3d
...
def parse_args():
    ...
    parser.add_argument(
        ...
        nargs='+',
        default=100,
        help='number of scenes to animate')
    parser.add_argument(
        '--pose_path',
        type=str,
        nargs='+',
        default='demo/ani/emotion_smoothed.pkl',
...
def main():
    ...
    for eval_cfg in cfg.evaluation:
        ...
        log_vars = animate_3d(
            model, batch_size=cfg.data.samples_per_gpu, max_num_scenes=max_num_scenes, smplx_path=args.pose_path, metrics=None,
            feed_batch_size=eval_cfg.get('feed_batch_size', 32),
            viz_dir=eval_cfg.get('viz_dir', 'viz_uncond') + '_animate',
