...
from lib.apis import evaluate_3d, recon_3d
...
def main():
    ...
    for eval_cfg in cfg.evaluation:
        ...
        cfg.data['train'].update({'code_dir':'/mnt/sdb/zwt/LayerAvatar/cache/ssdnerf_avatar_uncond_16bit_composite_thu/code'})
        ...
        viz_dir = os.path.join(os.path.dirname(eval_cfg.get('viz_dir', None)), 'val_recon_pose')
        log_vars = recon_3d(
        ...
        # video_3d(model, data_loader, metrics=metrics,
        #     feed_batch_size=eval_cfg.get('feed_batch_size', 32),
        #     viz_dir=viz_dir,
        #     viz_step=eval_cfg.get('viz_step', 1),
        #     sample_kwargs=eval_cfg.get('sample_kwargs', dict()))
