...
wget -O smplx_vert_segmentation.json "https://raw.githubusercontent.com/Meshcapade/wiki/main/assets/SMPL_body_segmentation/smplx/smplx_vert_segmentation.json"
